 ...
 */
final class Version20231115165758 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE wheels (id INT AUTO_INCREMENT NOT NULL, wheels_brand_id INT DEFAULT NULL, wheels_diameter VARCHAR(255) NOT NULL, wheels_height INT NOT NULL, wheels_width INT NOT NULL, UNIQUE INDEX UNIQ_4C07AA819DAB8EB9 (wheels_brand_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

...
class __TwigTemplate_b5f97fc87e6fea2c6625dca00ead160f extends Template
{
    private $source;
    private $macros = [];
...
{% else %}
    ...
    {% endfor %}
{% endif %}
", "@EasyAdmin/crud/field/country.html.twig", "/home/simonchik/IdeaProjects/victory/vendor/easycorp/easyadmin-bundle/src/Resources/views/crud/field/country.html.twig");
    }
}

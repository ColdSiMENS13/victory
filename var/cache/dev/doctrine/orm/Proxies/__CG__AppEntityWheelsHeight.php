 ...
 */
class WheelsHeight extends \App\Entity\WheelsHeight implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\WheelsHeight' . "\0" . 'id', '' . "\0" . 'App\\Entity\\WheelsHeight' . "\0" . 'height', '' . "\0" . 'App\\Entity\\WheelsHeight' . "\0" . 'wheels'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WheelsHeight $proxy) {

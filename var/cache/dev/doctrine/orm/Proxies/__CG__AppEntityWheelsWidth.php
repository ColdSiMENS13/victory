 ...
 */
class WheelsWidth extends \App\Entity\WheelsWidth implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\WheelsWidth' . "\0" . 'id', '' . "\0" . 'App\\Entity\\WheelsWidth' . "\0" . 'width', '' . "\0" . 'App\\Entity\\WheelsWidth' . "\0" . 'wheels'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WheelsWidth $proxy) {

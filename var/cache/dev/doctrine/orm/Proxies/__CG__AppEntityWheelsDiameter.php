 ...
 */
class WheelsDiameter extends \App\Entity\WheelsDiameter implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\WheelsDiameter' . "\0" . 'id', '' . "\0" . 'App\\Entity\\WheelsDiameter' . "\0" . 'diameter', '' . "\0" . 'App\\Entity\\WheelsDiameter' . "\0" . 'wheels'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WheelsDiameter $proxy) {
